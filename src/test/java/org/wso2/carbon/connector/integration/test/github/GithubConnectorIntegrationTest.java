...
public class GithubConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        init("github-connector-1.0.3-SNAPSHOT");
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateBlobWithMandatoryParameters"},
            description = "github {createBlob} integration test negative case.")
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateBlobNegativeCase"},
            description = "github {getBlob} integration test with mandatory parameters.")
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testGetBlobWithMandatoryParameters"},
            description = "github {getBlob} integration test with negative case.")
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testGetBlobWithNegativeCase"},
            description = "github {createCommit} integration test with mandatory parameters.")
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateCommitWithMandatoryParameters"},
            description = "github {createCommit} integration test with optional parameters.")
     ...
     */
    @Test(priority = 1, dependsOnMethods = {"testCreateCommitWithOptionalParameters"},
            description = "github {createCommit} integration test negative case.")
    ...
    /**
     * Positive test case for getFeeds method with mandatory parameters.
     */
    @Test(priority = 1, description = "github {getFeeds} integration test with mandatory parameters.")
    public void testGetFeedsWithMandatoryParameters() throws IOException, JSONException {
        esbRequestHeadersMap.put("Action", "urn:getFeeds");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getFeeds_mandatory.json");
        String apiEndPoint = connectorProperties.getProperty("githubApiUrl") + "/feeds";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    /**
     * Positive test case for getRepositoryEvents method with mandatory parameters.
     */
    @Test(priority = 1, description = "github {getRepositoryEvents} integration test with mandatory parameters.")
    public void testgetRepositoryEventsWithMandatoryParameters() throws IOException, JSONException {
        esbRequestHeadersMap.put("Action", "urn:getRepositoryEvents");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(proxyUrl, "POST",
                esbRequestHeadersMap, "esb_getRepositoryEvents_mandatory.json");
        String apiEndPoint = connectorProperties.getProperty("githubApiUrl") + "/"
                + "repos/" + connectorProperties.getProperty("owner")
                + "/" + connectorProperties.getProperty("repo") + "/events";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), esbRestResponse.getHttpStatusCode());
    }
    ...
    public void testGetOrganizationWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("githubApiUrl") + "/orgs/"
                + connectorProperties.getProperty("org");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(apiRestResponse.getHttpStatusCode(), esbRestResponse.getHttpStatusCode());
    }
